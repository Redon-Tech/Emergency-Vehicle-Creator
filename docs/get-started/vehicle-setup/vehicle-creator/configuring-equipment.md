...
Light Prefix changes the names used for the lights from that equipment. The resulting light names are used by the pattern creator.

If a pattern cannot find a light, check the equipment name and Light Prefix first.